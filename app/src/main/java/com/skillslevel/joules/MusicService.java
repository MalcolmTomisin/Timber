...
import com.skillslevel.joules.helpers.MediaButtonIntentReceiver;
import com.skillslevel.joules.helpers.MusicPlaybackTrack;
import com.skillslevel.joules.permissions.AllPermissions;
import com.skillslevel.joules.stores.MusicPlaybackState;
import com.skillslevel.joules.stores.RecentStore;
import com.skillslevel.joules.stores.SongPlayCount;
...
import static com.skillslevel.joules.MusicPlayer.getTrackName;

public class MusicService extends Service {
        public static final String PLAYSTATE_CHANGED = "com.skillslevel.joules.playstatechanged";
        public static final String POSITION_CHANGED = "com.skillslevel.joules.positionchanged";
        public static final String META_CHANGED = "com.skillslevel.joules.metachanged";
        public static final String QUEUE_CHANGED = "com.skillslevel.joules.queuechanged";
        public static final String PLAYLIST_CHANGED = "com.skillslevel.joules.playlistchanged";
        public static final String REPEATMODE_CHANGED = "com.skillslevel.joules.repeatmodechanged";
        public static final String SHUFFLEMODE_CHANGED = "com.skillslevel.joules.shufflemodechanged";
        public static final String TRACK_ERROR = "com.skillslevel.joules.trackerror";
        public static final String TIMBER_PACKAGE_NAME = "com.skillslevel.joules";
        public static final String MUSIC_PACKAGE_NAME = "com.android.music";
        public static final String SERVICECMD = "com.skillslevel.joules.musicservicecommand";
        public static final String TOGGLEPAUSE_ACTION = "com.skillslevel.joules.togglepause";
        public static final String PAUSE_ACTION = "com.skillslevel.joules.pause";
        public static final String STOP_ACTION = "com.skillslevel.joules.stop";
        public static final String PREVIOUS_ACTION = "com.skillslevel.joules.previous";
        public static final String PREVIOUS_FORCE_ACTION = "com.skillslevel.joules.previous.force";
        public static final String NEXT_ACTION = "fcom.skillslevel.joules.next";
        public static final String REPEAT_ACTION = "com.skillslevel.joules.repeat";
        public static final String SHUFFLE_ACTION = "com.skillslevel.joules.shuffle";
        public static final String FROM_MEDIA_BUTTON = "frommediabutton";
        public static final String REFRESH = "com.skillslevel.joules.refresh";
        public static final String UPDATE_LOCKSCREEN = "com.skillslevel.joules.updatelockscreen";
        ...
        private static final String SHUTDOWN = "com.skillslevel.joules.shutdown";
    ...
    private static final int NOTIFICATION_ID = 101;
        ...
        private void setUpMediaSession() {
            mSession = new MediaSessionCompat(this, "Joules");
        ...
        private void addToPlayList(final long[] list, int position, long sourceId, JoulesUtil.IdType sourceType) {
        ...
        private void doAutoShuffleUpdate() {
            ...
            for (int i = 0; i < toAdd; i++) {
                ...
                mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, JoulesUtil.IdType.NA, -1));
                notify = true;
            }
            if (notify) {
                notifyChange(QUEUE_CHANGED);
        ...
        private void updateMediaSession(final String what) {
            ...
            if (what.equals(PLAYSTATE_CHANGED) || what.equals(POSITION_CHANGED)) {
                ...
                Bitmap albumArt = ImageLoader.getInstance().loadImageSync(JoulesUtil.getAlbumArtUri(getAlbumId()).toString());
                if (albumArt != null) {
        ...
        private Notification buildNotification() {
            ...
            int playButtonResId = isPlaying
                    ? R.drawable.btn_pause_active : R.drawable.ic_play_button_mini;

            Intent nowPlayingIntent = NavigationUtils.getNowPlayingIntent(this);
            PendingIntent clickIntent = PendingIntent.getActivity(this, 0, nowPlayingIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            Bitmap artwork;
            artwork = ImageLoader.getInstance().loadImageSync(JoulesUtil.getAlbumArtUri(getAlbumId()).toString());

            if (artwork == null) {
                artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_music_art_layers);
            }
            ...
            int notificationAction = R.drawable.ic_play;
   ...
   // ((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).notify(NOTIFICATION_ID, builder.build());
            ...
            if (PreferencesUtil.getInstance(this).getXPosedTrackselectorEnabled()) {
                addXTrackSelector(n);
            }
                    ...
                    do {
                        TrackItem t = new TrackItem()
                                .setArt(ImageLoader.getInstance()
                                        .loadImageSync(JoulesUtil.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))).toString()))
                                ...
                                .setDuration(JoulesUtil.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                        list.add(t.get());
                    } while (c.moveToNext());
                    try {
                    ...
                    try {
                        if (mCursor != null && shouldAddToPlaylist) {
                            ...
                            mPlaylist.add(new MusicPlaybackTrack(
                                    mCursor.getLong(IDCOLIDX), -1, JoulesUtil.IdType.NA, -1));
                            notifyChange(QUEUE_CHANGED);
                            mPlayPos = 0;
                            mHistory.clear();
                        }
        ...
        public void open(final long[] list, final int position, long sourceId, JoulesUtil.IdType sourceType) {
            synchronized (this) {
                if (mShuffleMode == SHUFFLE_AUTO) {
        ...
        public void enqueue(final long[] list, final int action, long sourceId, JoulesUtil.IdType sourceType) {
            synchronized (this) {
...
//            }
        ...
        private static final class ServiceStub extends IJoulesInterface.Stub {
            ...
            public void open(final long[] list, final int position, long sourceId, int sourceType)
                ...
                mService.get().open(list, position, sourceId, JoulesUtil.IdType.getTypeById(sourceType));
            }
            ...
            public void enqueue(final long[] list, final int action, long sourceId, int sourceType)
                    throws RemoteException {
                mService.get().enqueue(list, action, sourceId, JoulesUtil.IdType.getTypeById(sourceType));
            }
