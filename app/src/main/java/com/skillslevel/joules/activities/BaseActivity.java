...
import com.skillslevel.joules.IJoulesInterface;
...
import com.skillslevel.joules.subfragments.QuickControlsFragment;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!JoulesUtil.hasEffectsPanel(BaseActivity.this)) {
