...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public ArtistAdapter(Activity context, List<Artist> arraylist) {
        ...
        this.isGrid = PreferencesUtil.getInstance(mContext).isArtistsInGrid();
    }
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = JoulesUtil.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = JoulesUtil.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(JoulesUtil.makeCombinedString(mContext, albumNmber, songCount));
