...
import com.skillslevel.joules.widgets.PlayPauseButton;
import com.skillslevel.joules.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(JoulesUtil.makeShortTimeString(getActivity(), position / 1000));
            }
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = JoulesUtil.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void setSongDetails(View view) {
        ...
        if (playPauseFloating != null) {
            playPauseDrawable.setColorFilter(JoulesUtil.getBlackWhiteColor(accentColor), PorterDuff.Mode.MULTIPLY);
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(JoulesUtil.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
